...
static const Key keys[] = {
	...
	{ 0,                            XK_F6,     spawn,          {.v = (const char*[]){"sudo", "./bright.sh", "+5", NULL } } },
	{ 0,                            XK_F5,     spawn,          {.v = (const char*[]){"sudo", "./bright.sh", "-5", NULL } } },
	...
	{ ControlMask|Mod1Mask,         XK_f,      spawn,          {.v = (const char*[]){ALTBROWSER, NULL } } },
